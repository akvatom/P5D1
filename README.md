...
6. расчёт совместимости, сложности, безопасного покрытия и риск-слоя.
...
- 100 вопросов: 90 расчётных и 10 контрольных;
- ответы «Да», «Нет» и «Не могу оценить»;
- субшкалы и отдельная оценка надёжности по каждой оси;
...
- контрольная сумма и подпись профильного кода;
